...
> 本指南面向 AI Folks 社区（约 76 人）的共学活动，系统整理了从零开始构建 AI Agent 的优质开源资源、工具与学习路线。无论你是刚接触 Agent 概念的新手，还是希望深入工程实践的进阶开发者，都能在这里找到适合自己的学习路径。
...
以下是为 AI Folks 社区共学活动设计的 4 周学习计划，每周约投入 5-8 小时：
...
*本指南由 AI Folks 社区整理，持续更新中。欢迎提交 PR 补充优质资源！*
